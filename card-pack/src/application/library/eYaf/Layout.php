 ...
 *
 * Also allow to set variable to views and access them from the base
...
class Layout implements \Yaf\View_Interface {
    /**
     * The template engine to reader views and layout templates.
     * @var Yaf\View\Simple
     */
    public $engine;
    ...
    public function setScriptPath($path) {
        if(is_readable($path)) {
            ...
            // Overwrite layouts path by setting it where views path is.
    ...
    /**
     * Directly display the contents of a view / layout template.
     *
     * @param string $tpl      The template to process.
     * @param array  $tpl_vars Additional variables to be assigned to template.
     *
